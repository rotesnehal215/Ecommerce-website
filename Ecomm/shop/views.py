...
def checkout(request):
    if request.method == "POST":
        ...
        # request paytm to transfer the amount to ur account after payment made by user.
        param_dict = {
        ...
        # paytmChecksum = PaytmChecksum.generateSignature(param_dict, MERCHANT_KEY)
